...
{
	public static handanimations Instance;

	private Vector3 _handPosition;

	private Vector3 _offSet = new Vector3(0.04f, -0.024f, 0.0165f);

	public Vector3 HandPosition
	{
		get
		{
			return _handPosition-_offSet;
		}
	}
	...
	//Custom Animations
	int GrabVial = Animator.StringToHash("GrabVial");
	int GrabSyringe = Animator.StringToHash("GrabSyringe");
	int GrabGloveBox = Animator.StringToHash("GrabGloveBox");
	int GrabSanitizer = Animator.StringToHash("GrabSanitizer");
	...
	//Custom code written by David Milot
	public void SetHandToIdle()
	{
		anim.SetTrigger(Idle);
		OculusController.SetActive(false);
		ViveController.SetActive(false);
	...
	public void SetHandGrab(string itemName)
	{
		anim.SetTrigger(Animator.StringToHash(itemName));
		OculusController.SetActive(false);
		ViveController.SetActive(false);
		StickUp.SetActive(false);
		StickFront.SetActive(false);
